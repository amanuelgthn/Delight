...
const SignupForm = () => {
  ...
  if(!session) {
    return toast({ title: "Sign up failed. Please try again. ON sesssion"})
  }
  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        <img src="/assets/images/Delighticon.png"
         alt="logo"
         />
         <h2 className="h3-bold md:h2-bold pt-5 sm:pt-12">Create A New Account</h2>
         <p className="text-light-3 small-medium md:base-regular mt-2">Please enter your account information to begin using Delight</p>
